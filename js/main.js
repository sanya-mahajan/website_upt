...
//end of IIFE function
    ...
    $('a.contri').click(function() {
		

		//MODIFY THIS CODE TO DISPLAY THE CONTRIBUTION CARD
        
		var person_img = "media/team/images/Aarya_Pathania.jpeg";
		var person_name = "Arya";
		var contributions="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."
   ...
   //Dont touch this code
        ...
        // $.ajax({
        //     url: '/team/contributions/' + person_id ,
		...
		// 		content.innerHTML = '<span><img width=80vw height=90vh src="' + person_img + '" alt=""></span>'+'<span>'+"   "+person_name+'<br>'+data.contributions[0].contribution+'</span>'
		// 		// create close button
		// 		const closeBtn = document.createElement("button");
		// 		closeBtn.id = "close-btn";
		// 		closeBtn.innerHTML = "X";
